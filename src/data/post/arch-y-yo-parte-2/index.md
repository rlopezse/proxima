---
title: Arch y yo, parte 2
slug: arch-y-yo-parte-2
spoiler: Afinando detalles y pasando rabias
...
Cuando terminé de configurar todo el setup, caí en la cuenta de algo: Arch es básicamente una distro tipo servidor, pero con drivers y utilidades para usarse como computador de escritorio. Hay diferencias, claro, pero es parecido a tomar una Raspberry Pi con Ubuntu Server y agregarle soporte para monitor, teclado y parlantes. Nada más, nada menos.
...
¿Lo recomiendo? Depende. Si quieres aprender desde la base, instalar cosas y pasar un mal rato que vale la pena, sí. Pero si al final vas a terminar configurando todo para que se parezca a Mac o Windows, ahórrate el mal rato.
